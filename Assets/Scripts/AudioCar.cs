...
public class AudioCar : MonoBehaviour
{
    ...
    private Car m_CarController; // Reference to car we are controlling
    //private new Camera camera;

    private void Awake()
    {
        //camera = GameObject.FindGameObjectWithTag("FrontViewThirdPerson").GetComponent<Camera>();

        // get the carcontroller ( this will not be null as we have require component)
        m_CarController = GetComponent<Car>();
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            else
            {
                ...
                float accFade = Mathf.Abs(m_CarController.inputValue);
